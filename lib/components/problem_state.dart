...
class ProblemState with _$ProblemState {
  ...
  //問題を新規に生成する
  factory ProblemState.generate() =>
      ProblemState(numbers: List<int>.generate(2, (i) => Random().nextInt(10)));
}

extension ProblemStateHelpler on ProblemState {
  //問題文を返す
  String get sentence {
  ...
  ProblemStatus get status {
    ...
    try {
      final anwerInt = int.tryParse(answerString);
      return anwerInt == null
          ? ProblemStatus.formatError
          : anwerInt != correctNumber
